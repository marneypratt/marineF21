# Independent Project Data Analysis for Bio 269 Fall 2021
...
`use_course("https://github.com/marneypratt/marineF21/archive/main.zip")`
...
Start by opening the file "project_analysis.Rmd"

Import your data which should be in tidy format

Copy the code from the various script templates in the "script_templates" folder as needed and paste them in the "project_analysis.Rmd" file.  Replace the blanks in the code as needed.
